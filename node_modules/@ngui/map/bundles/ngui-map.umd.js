(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('@ngui/map', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
	(factory((global.ngui = global.ngui || {}, global.ngui.map = {}),global.ng.core,global.rxjs,global.Rx.Observable.prototype,global.ng.common));
...
var BaseMapDirective = /** @class */ (function () {
    function BaseMapDirective(nguiMapComponent, mapObjectName, inputs, outputs) {
        ...
        this.outputs.forEach(function (output) { return _this[output] = new core.EventEmitter(); });
        this.mapObjectName = mapObjectName;
    }
...
var NguiMapComponent = /** @class */ (function () {
    function NguiMapComponent(optionBuilder, elementRef, geolocation, geoCoder, nguiMap, apiLoader, zone) {
        ...
        apiLoader.load();
        OUTPUTS.forEach(function (output) { return _this[output] = new core.EventEmitter(); });
    }
    ...
    NguiMapComponent.prototype.initializeMap = function () {
        ...
        this.zone.runOutsideAngular(function () {
            ...
            _this.inputChanges$.pipe(operators.debounceTime(1000), operators.tap(function (changes) { return _this.nguiMap.updateGoogleObject(_this.map, changes); })).subscribe();
...
var InfoWindow = /** @class */ (function () {
    function InfoWindow(elementRef, nguiMap, nguiMapComponent) {
        ...
        OUTPUTS$2.forEach(function (output) { return _this[output] = new core.EventEmitter(); });
    }
    ...
    InfoWindow.prototype.initialize = function () {
        ...
        this.inputChanges$.pipe(operators.debounceTime(1000), operators.tap(function (changes) { return _this.nguiMap.updateGoogleObject(_this.infoWindow, changes); })).subscribe();
...
var CustomMarker = /** @class */ (function () {
    function CustomMarker(nguiMapComponent, elementRef, nguiMap) {
        ...
        this.inputChanges$ = new rxjs.Subject();
        this.elementRef.nativeElement.style.display = 'none';
        OUTPUTS$3.forEach(function (output) { return _this[output] = new core.EventEmitter(); });
    }
    ...
    CustomMarker.prototype.initialize = function () {
        ...
        this.inputChanges$.pipe(operators.debounceTime(1000), operators.tap(function (changes) { return _this.nguiMap.updateGoogleObject(_this.mapObject, changes); })).subscribe();
...
PlacesAutoComplete.propDecorators = {
    ...
    "componentRestrictions": [{ type: core.Input },],
...
//# sourceMappingURL=ngui-map.umd.js.map
