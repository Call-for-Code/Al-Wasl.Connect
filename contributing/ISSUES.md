...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in Al-Wasl.Connect, creating a new issue in the `Call-for-Code/Al-Wasl.Connect`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `Call-for-Code/Al-Wasl.Connect` in a concrete and reviewable manner.
...
When opening a new issue in the `Call-for-Code/Al-Wasl.Connect` issue tracker, please provide as much
